      ...
      <article class="project-card${project.featured ? ' project-card--featured' : ''}" role="listitem" data-id="${project.id}" style="--card-index: ${index}">
        ...
        <footer class="project-card__footer">
          ...
          <div class="project-card__links">
            ${project.links.live ? `
              <a class="project-card__link" href="${project.links.live}" target="_blank" rel="noopener" aria-label="Ver ${project.title} online" title="Demo ao vivo">
            ...
            ` : ''}
            ${project.links.code ? `
              <a class="project-card__link" href="${project.links.code}" target="_blank" rel="noopener" aria-label="Código fonte do ${project.title}" title="Código fonte">
